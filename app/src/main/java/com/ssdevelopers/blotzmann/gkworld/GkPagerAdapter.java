...
public class GkPagerAdapter extends PagerAdapter {
    ...
    GkPagerAdapter(Context context, String response){
        mcontext = context;
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        View item = layoutInflater.inflate(R.layout.image_slider_layout_item, container, false);
        AppCompatImageView imageView = (AppCompatImageView) item.findViewById(R.id.home_gk_image);
        try {
